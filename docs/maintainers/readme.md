...
Documentation for people working on rooted itself. The "why" behind the code style and the package layout.

For the "how to behave" side (PR etiquette, commit conventions, code of conduct), see [contributing/](../contributing).
