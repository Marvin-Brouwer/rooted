/**
 * Base adapter primitives for rooted adapter packages.
 *
 * - [Adapters guide](https://github.com/Marvin-Brouwer/rooted/blob/main/docs/guide/adapters.md)
 *
 * @module
 */
...
export * from '../utility/redirects-file.mts'
