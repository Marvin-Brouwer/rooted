/**
 * Vite plugin that auto-discovers `_routes.mts` files and writes a single aggregator module (`_routes.g.mts`) that re-exports every route.
 * Spread the result into `router({ ... })`.
 *
 *
