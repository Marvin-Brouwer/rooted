...
export { route, type Route, type RouteBuilder, type RouteParameterDictionary, type RouteSeoResolver } from '../route.mts'
export type { AnyRouteSeoResolver, RouteMetadata, RouteSeoMetadata } from '../route.metadata.mts'
