 ...
 *
 * Separate from the components package's signal on purpose: stores are usable without the rest of the framework,
 * and neither half should be able to abort the other's listeners.
 */
