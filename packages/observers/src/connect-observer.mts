 ...
 *
 * The three observers don't agree on what `observe()` takes,
 * so the call itself is passed in rather than described in the type.
 * A signal that has already aborted observes nothing.
 */
