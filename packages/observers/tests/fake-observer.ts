...
/**
 * Replaces a global observer constructor with a fake that records what it was handed,
 * and lets the test fire the callback on demand.
 *
 * happy-dom does provide all three observers,
 * but none of them fire without a layout engine,
 * and none of them let you read back the options they were given.
 * Returns the list every constructed instance lands in.
 */
...
/**
 * The one instance the wrapper should have constructed.
 * Fails the test if the wrapper built none, or more than one.
 */
