...
/**
 * Sits under the demo banner and stays empty until the service worker has a new
 * version waiting. rooted doesn't swap a running page, so this is how you get
 * the new version without waiting for the next visit.
 */
	...
	onMount({ append, create, element }) {
		append(create(UpdateNotification, {
			children: element('div', {
				...
				role: 'status',
				children: [
					element('span', { textContent: 'A new version of this app is available.' }),
